                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/pricing" className="text-base text-gray-500 hover:text-blue-600 transition-colors">
                                    Pricing
                                </Link>
                            </li>
                            <li>
                                <Link href="/dashboard" className="text-base text-gray-500 hover:text-blue-600 transition-colors">
                                    Analytics
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link href="/terms" className="text-base text-gray-500 hover:text-blue-600 transition-colors">
                                    Terms of Service
                                </Link>
                            </li>
                        </ul>
